...
addLayer("公式", {
    ...
    tabFormat: [
        ...
        ["display-text", function() {
            ...
            "“稀释 1”层公式：<br>最大一重稀释点增益效果公式：(最大一重稀释点+1)^0.4<br>充能按钮长按时间每秒会乘以衰减系数<br>充能按钮长按时间在“稀释 1”层重置与退出稀释域时不会被重置<br>倍率系数=1+(((5^0.5-1)/2)×((长按时间+1)^0.08))×(p1层升级13效果)<br>充能按钮的充能倍率=1+((倍率系数-1)×(1-1÷((长按时间+1)^0.4)))<br>泡泡1价格公式：(2×(购买次数^0.01))^(购买次数^1.022)<br>泡泡2价格公式：(6×(购买次数^0.01))^(购买次数^1.044)<br>泡泡3价格公式：(24×(购买次数^0.01))^(购买次数^1.088)" 
        }],
    ],
})