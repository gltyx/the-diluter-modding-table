...
var systemComponents = {
    ...
    'info-tab': {
		...
		<div style="border: 3px solid #888; width:300px; height:30px; margin-top: 8px; padding:15px; border-radius: 5px; display: inline-table">
			<h3>{{i18n("本游戏作者", "Mod Author", false)}}:</h3><br>
		...
		<div style="border: 3px solid #888; width:300px; height:30px; margin-top: 8px; padding:15px; border-radius: 5px; display: inline-table">
			<h3>{{i18n("本游戏QQ群", "Mod Author", false)}}:</h3><br>
			1005676561<br><br>
			<h6 style="color:#aaa">({{i18n("也没什么好说的啦……", "Based On Shinwmyste\'s The Modding Table", false)}})</h6>
		</div>
		<br><br><br><h2>{{i18n("模版信息", "Authors", false)}}:</h2><br><br>
		<div style="border: 3px solid #888; width:300px; height:30px; margin-top: 8px; padding:15px; border-radius: 5px; display: inline-table">
        ...
        <h2>{{i18n("模版作者其他页面", "Other Pages", false)}}:</h2><br><br>
		<div style="border: 3px solid #888; width:300px; height:30px; margin-top: 8px; padding:15px; border-radius: 5px; display: inline-table">
